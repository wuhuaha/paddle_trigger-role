...
model_g.add_arg("ernie_config_path", str, None,
...
model_g.add_arg(
    "init_pretraining_params", str, None,
...
train_g.add_arg("crf_learning_rate", float, 0.2, "Learning rate for crf")
train_g.add_arg("lr_scheduler",
                str,
                "linear_warmup_decay",
...
train_g.add_arg("use_dynamic_loss_scaling", bool, True,
...
train_g.add_arg("incr_every_n_steps", int, 100,
...
data_g.add_arg("bset_not_null_pred_thres", float, 0.95,
               "best not null threshold")
data_g.add_arg(
    "doc_stride", int, 128,
...
data_g.add_arg("role_pred_save_path", str, None, "role prediction save path")
data_g.add_arg("trigger_pred_save_path", str, None,
               "trigger prediction save path")
data_g.add_arg("chunk_scheme",
               type=str,
               default="IOB",
               choices=["plain", "IOB", "IOE", "IOBES"],
               help="chunk scheme")

run_type_g = ArgumentGroup(parser, "run_type", "running type options.")
run_type_g.add_arg("use_cuda", bool, True, "If set, use GPU for training.")
run_type_g.add_arg("is_distributed", bool, False,
                   "If set, then start distributed training.")
run_type_g.add_arg("use_fast_executor", bool, False,
                   "If set, use fast parallel executor (in experiment).")
run_type_g.add_arg("num_iteration_per_drop_scope", int, 10,
                   "Iteration intervals to drop scope.")
run_type_g.add_arg("do_train", bool, True, "Whether to perform training.")
run_type_g.add_arg("do_val", bool, True,
...
run_type_g.add_arg("use_multi_gpu_test", bool, False,
                   "Whether to perform evaluation using multiple gpu cards")
run_type_g.add_arg("metrics", bool, True,
                   "Whether to perform evaluation on test data set.")
run_type_g.add_arg("shuffle", bool, True, "")
run_type_g.add_arg("for_cn", bool, True,
